...
export const INDIAN_COA_TEMPLATE: DefaultAccountTemplate[] = [
  ...
  // Accumulated Depreciation (1600-1609)
  {
    code: '1600',
    ...
    isTDSAccount: false,
    isBankAccount: false,
    description: 'Contra asset accounts for accumulated depreciation',
  },
  {
    code: '1601',
    name: 'Accum. Dep. - Plant & Machinery',
    accountType: 'ASSET',
    accountCategory: 'FIXED_ASSETS',
