 ...
 *
 * Counter key: transaction-{type}-{year}-{month}
 * This is a single-tenant system. entityId on transactions is the counterparty
 * (vendor/customer), NOT a tenant ID, so numbers are NOT scoped by entity.
 *
