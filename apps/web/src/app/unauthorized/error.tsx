...
const logger = createLogger({ context: 'UnauthorizedError' });
...
/**
 * Error Boundary for Unauthorized Module
 */
export default function UnauthorizedError({ error, reset }: ErrorProps) {
  const router = useRouter();

  useEffect(() => {
    logger.error('Unauthorized page error', {
    ...
    Sentry.withScope((scope) => {
      scope.setTag('module', 'unauthorized');
      scope.setTag('errorBoundary', 'unauthorized-module');
      if (error.digest) {
