...
import type { SubcooledResult, PressureUnit } from './types';
import { convertBarToPressureUnit, getPressureUnitLabel } from './pressureUtils';

interface SubcooledResultsProps {
  result: SubcooledResult;
  pressureUnit: PressureUnit;
}

export function SubcooledResults({ result, pressureUnit }: SubcooledResultsProps) {
  return (
    <Paper sx={{ p: 3 }}>
      ...
      >
        ...
        <Box>
          ...
          <Typography variant="h5">{result.subcooling.toFixed(2)} °C</Typography>
        </Box>
      </Box>
        ...
        <Table size="small">
          ...
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell align="right">{result.density.toFixed(2)}</TableCell>
              <TableCell align="right">kg/m³</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Specific Volume (v)</TableCell>
              <TableCell align="right">{result.specificVolume.toFixed(6)}</TableCell>
