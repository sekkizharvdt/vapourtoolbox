...
/**
 * Generate Report Dialog — TVC Calculator
 *
 * Dialog for configuring and downloading a TVC PDF report.
...
export function GenerateReportDialog({
  ...
  const [documentNumber, setDocumentNumber] = useState('TVC-001');
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      <DialogTitle>Generate TVC Report</DialogTitle>
      <DialogContent>
        <Stack spacing={3} sx={{ mt: 1 }}>
          ...
          <TextField
            ...
            placeholder="Project Alpha — TVC-101"
            fullWidth
