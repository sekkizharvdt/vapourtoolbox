...
const ALL_CALCULATORS: Calculator[] = [
  ...
  {
    title: 'Custom Tube Bundle',
    description:
      'Design a custom tube bundle — choose boundary shape (circle, half-circle, rectangle), pitch, and tube specs to calculate tube count and surface area.',
    icon: <BundleIcon sx={{ fontSize: 40 }} />,
    href: '/thermal/calculators/custom-bundle',
    status: 'available',
    reference: 'Triangular Pitch',
    keywords: ['tube bundle', 'tube count', 'tube sheet', 'pitch', 'layout', 'geometry'],
  },
  {
    title: 'Lateral Tube Bundle',
    description:
      'Design a half-shell lateral tube bundle with diagonal vapour escape lanes, nozzle exclusions, and spray nozzle integration for MED evaporators.',
    icon: <LateralIcon sx={{ fontSize: 40 }} />,
    href: '/thermal/calculators/lateral-bundle',
    status: 'available',
    reference: 'MED Design',
    keywords: [
      'lateral',
      'half shell',
      'vapour lane',
  ...
  {
    title: 'Central Tube Bundle',
    description:
      'Design a rectangular tube bundle centred inside a cylindrical shell with seawater or brine spray distribution.',
    icon: <CentralIcon sx={{ fontSize: 40 }} />,
    href: '/thermal/calculators/central-bundle',
    status: 'available',
    reference: 'MED Design',
    keywords: ['central', 'rectangular', 'tube bundle', 'cylindrical shell', 'seawater', 'brine'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Free ΔL and restrained thermal stress for carbon steel, SS 304, aluminium 5052 and titanium SB 338 Gr 2. Temperature-dependent α(T) and E(T) from Perry’s / ASM Handbook.',
    icon: <ExpansionIcon sx={{ fontSize: 40 }} />,
    href: '/thermal/calculators/thermal-expansion',
    status: 'available',
    reference: "Perry's / ASM",
    keywords: [
      'thermal expansion',
      'linear expansion',
  ...
  },
  {
    ...
    calculators: ALL_CALCULATORS.filter((c) =>
      [
        ...
        '/thermal/calculators/thermal-expansion',
