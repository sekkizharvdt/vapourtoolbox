// rule28-exempt: terminal — match is generated by joining PO + GR + Bill at /new; on the detail page only resolve-discrepancy/approve/reject dialogs run, no field edits
