    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          id: 'po-payments',
          title: 'PO Payments',
          description: 'Paid and pending amounts per PO, with milestone-wise breakdown',
          icon: <PaymentsIcon sx={{ fontSize: 48, color: 'primary.main' }} />,
          path: '/procurement/po-payments',
        },
      ],
    },
    {
