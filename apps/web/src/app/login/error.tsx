...
const logger = createLogger({ context: 'LoginError' });
...
/**
 * Error Boundary for Login Module
 */
export default function LoginError({ error, reset }: ErrorProps) {
  useEffect(() => {
    logger.error('Login module error', {
    ...
    Sentry.withScope((scope) => {
      ...
      scope.setTag('errorBoundary', 'login-module');
      if (error.digest) {
        ...
        <Stack spacing={3} alignItems="center">
          ...
          <Alert severity="warning" sx={{ width: '100%' }}>
            <Typography variant="body1">
              An error occurred during login. Please try refreshing the page.
            </Typography>
          </Alert>
