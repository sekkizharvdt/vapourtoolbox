...
const logger = createLogger({ context: 'CompanyError' });
...
/**
 * Error Boundary for Company Module
 */
export default function CompanyError({ error, reset }: ErrorProps) {
  ...
  useEffect(() => {
    ...
    Sentry.withScope((scope) => {
      scope.setTag('module', 'company');
      scope.setTag('errorBoundary', 'company-module');
      if (error.digest) {
        ...
        <Stack spacing={3} alignItems="center">
          ...
          <Alert severity="warning" sx={{ width: '100%' }}>
            <Typography variant="body1">
              An error occurred in the company settings module. Please try refreshing the page.
            </Typography>
          </Alert>
