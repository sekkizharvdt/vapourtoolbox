...
export default function EntitiesLayout({ children }: { children: React.ReactNode }) {
  ...
  // Check permissions - require VIEW_ENTITIES minimum
  const userPermissions = claims.permissions || 0;
  const hasEntityPermission = canViewEntities(userPermissions);
      ...
      <Container maxWidth="xl">
        <Box sx={{ py: 4, textAlign: 'center' }}>
          ...
          <Typography variant="body1" color="text.secondary">
            You do not have permission to access entity management.
          </Typography>
        </Box>
      </Container>
    );
