...
const logger = createLogger({ context: 'MaterialsError' });
...
/**
 * Error Boundary for Materials Module
 */
export default function MaterialsError({ error, reset }: ErrorProps) {
  const router = useRouter();

  useEffect(() => {
    logger.error('Materials module error', {
    ...
    Sentry.withScope((scope) => {
      scope.setTag('module', 'materials');
      scope.setTag('errorBoundary', 'materials-module');
      if (error.digest) {
        ...
        <Stack spacing={3} alignItems="center">
          ...
          <Alert severity="warning" sx={{ width: '100%' }}>
            <Typography variant="body1">
              An error occurred in the materials module. Please try refreshing the page.
            </Typography>
          </Alert>
