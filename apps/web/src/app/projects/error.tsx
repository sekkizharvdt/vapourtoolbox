...
/**
 * Error Boundary for Projects Module
 *
 * Catches and handles errors in the projects module with module-specific
...
export default function ProjectsError({ error, reset }: ErrorProps) {
  ...
  useEffect(() => {
    ...
    logger.error('Projects module error', {
        ...
        <Stack spacing={3} alignItems="center">
          ...
          <Alert severity="error" sx={{ width: '100%' }}>
            <Typography variant="body1">
              An error occurred while managing your project. Your data has not been modified. Please
