...
const SHAPE_CATALOG: Record<string, Shape[]> = {
  plates: [
    { ...rectangularPlate, id: 'rectangular-plate' },
    { ...circularPlate, id: 'circular-plate' },
    { ...customPlate, id: 'custom-plate' },
  ] as Shape[],
  tubes: [{ ...straightTube, id: 'straight-tube' }] as Shape[],
  'pressure-vessels': [
    { ...cylindricalShell, id: 'cylindrical-shell' },
    { ...conicalShell, id: 'conical-shell' },
    { ...hemisphericalHead, id: 'hemispherical-head' },
    { ...ellipsoidalHead, id: 'ellipsoidal-head' },
    { ...torisphericialHead, id: 'torispherical-head' },
    { ...flatHead, id: 'flat-head' },
    { ...conicalHead, id: 'conical-head' },
  ] as Shape[],
  'heat-exchangers': [
    { ...hxTubeBundle, id: 'hx-tube-bundle' },
    { ...hxTubeSheet, id: 'hx-tube-sheet' },
    { ...hxBaffle, id: 'hx-baffle' },
    { ...hxTubeSupport, id: 'hx-tube-support' },
  ] as Shape[],
  nozzles: [
    { ...nozzleAssembly, id: 'nozzle-assembly' },
    { ...reinforcementPad, id: 'reinforcement-pad' },
    { ...customCircularNozzle, id: 'custom-circular-nozzle' },
    { ...customRectangularNozzle, id: 'custom-rectangular-nozzle' },
    { ...manwayAssembly, id: 'manway-assembly' },
  ] as Shape[],
};
