...
| ------------------------------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [2026-08-07 simulator bridge next stage](2026-08-07-simulator-bridge-next-stage-plan.md)          | **Active plan**    | THE plan for this track. Binding constraint has moved to Toolbox (control definition, rung 6). Phase 0 = refresh a 23-revision-stale spec; 4 decisions open        |
| [2026-08-05 dynamic simulator bridge handoff](2026-08-05-simulator-bridge-handoff.md)             | Cold-start record  | Context doc for the simulator collaboration, superseded as the _plan_ by the 2026-08-07 doc above. Items 1–4 shipped; items 5–6 carried forward into Phase 1       |
| [2026-07-29 seawater enthalpy & NCG model](2026-07-29-seawater-enthalpy-and-ncg-model.md)         | Findings + plan    | 7 findings in the thermal property/NCG stack. 1, 2, 5 **fixed**; 3, 4 **closed** (structurally cannot affect GOR); 7 partly fixed; 6 + fouling reconciliation open |
