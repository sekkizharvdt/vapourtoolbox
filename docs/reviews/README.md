...
| ------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [2026-08-05 dynamic simulator bridge handoff](2026-08-05-simulator-bridge-handoff.md)             | **WIP handoff**    | Cold-start record for the simulator collaboration. Items 1–2 shipped; UI, NPSHa consolidation, metal-mass geometry and the methodology rules pending; 2 decisions open |
