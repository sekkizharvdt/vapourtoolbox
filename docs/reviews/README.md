...
| ------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------------- |
| [2026-07-29 seawater enthalpy & NCG model](2026-07-29-seawater-enthalpy-and-ncg-model.md)         | Findings + plan    | 7 findings in the thermal property/NCG stack. 1, 2, 5 **fixed**; 3, 4 **closed** (structurally cannot affect GOR); 6, 7 open |
