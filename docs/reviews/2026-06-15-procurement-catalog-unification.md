...
**Status:** Design for review — no code written yet. Phase 1 is ready to implement on approval; Phases 2–3 are the sustainable target and can be sequenced later.
