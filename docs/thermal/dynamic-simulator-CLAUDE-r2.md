...
| Rev    | Date       | Change                                                                                                                                                                      |
| ------ | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| r1     | 2026-07-29 | Initial draft. **Not retained** — edited in place before revision numbering was adopted, and never committed.                                                               |
| **r2** | 2026-07-29 | Rule 4 fixture hierarchy corrected; rule 12 covers rungs with no external reference; rule 8 and 14 realigned with the specification; every rule tagged with its provenance. |
